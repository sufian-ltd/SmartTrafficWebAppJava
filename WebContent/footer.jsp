<section id="footer" style="background: #000042;font-family: serif;font-size: 17px;color: #fff">
	<br></br>
	<div class="container">
...
<!-- 				<p class="h6"> -->
<!-- 					&copy All right Reversed.<a class="text-white ml-2" href="#" -->
<!-- 						target="_blank">Sufian Vhaiya</a> -->
				<p class="h5">
					&copy All right Reversed Sufian Vhaiya
				</p>
			</div>
			<hr>
		</div>
